...
test('immutability', () => {
    ...
    decorate(multi_line_config, mask(multi_line_config, grid(multi_line_config, cache)), storage)
...
test('build single line grid', () => {
    ...
    const { prize, lines } = decorate(single_line_config, m, storage)
...
test('build multi line grid', () => {
    ...
    const { prize, lines } = decorate(multi_line_config, m, storage)
